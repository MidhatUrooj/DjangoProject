...
from .import views
from .views import ( McQSAllListView, BookListView,BookDetailView,AuthorListView,AuthorDetailView,LoanedBooksByUserListView,
...
urlpatterns = [
	...
	path(r'borroweds/', McQSAllListView.as_view(), name='all-orrowed'),
